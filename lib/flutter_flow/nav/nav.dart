...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/productsPage',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'ProductsPage')
        ...
        FFRoute(
          name: 'MySubscribedItems',
          path: '/mySubscribedItems',
          builder: (context, params) => const MySubscribedItemsWidget(),
        ),
        FFRoute(
          name: 'lossConnection',
          path: '/lossConnection',
