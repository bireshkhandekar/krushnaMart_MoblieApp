                              ...
                              children: [
                                PagedListView<ApiPagingParams, dynamic>(
                                  pagingController:
                                    ...
                                    (nextPageMarker) => KMartAPIsGroup
                                        .getOrdersByUserIdCall
                                        .call(
                                      userId: currentUserData?.id,
                                      limit: 10,
                                      pageno: nextPageMarker.nextPageNumber + 1,
                                      token: currentAuthenticationToken,
                                    ),
                                  ),
                                  ...
                                  builderDelegate:
                                    ...
                                    itemBuilder: (context, _, getordersIndex) {
                                      final getordersItem = _model
                                          .listViewPagingController1!
                                          .itemList![getordersIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            4.0, 0.0, 4.0, 0.0),
                                        child: Card(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        if (currentAuthenticationToken !=
                                                                            ...
                                                                            currentAuthenticationToken !=
                                                                                '') {
                                                                          _model.detailsapiResulta5j = await KMartAPIsGroup
                                                                              .tokenValidetionCall
                                                                              .call(
                                                                            token:
                                                                                currentAuthenticationToken,
                                                                          ...
                                                                          if (!(_model.detailsapiResulta5j?.succeeded ??
                                                                              true)) {
                                                                            _model.detailsapiResultrefreshtoken =
                                                                                await KMartAPIsGroup.refreshTokenCall.call(
                                                                              refreshToken: currentAuthRefreshToken,
                                                                            );

                                                                            if ((_model.detailsapiResultrefreshtoken?.succeeded ??
                                                                                true)) {
                                                                              authManager.updateAuthUserData(
                                                                                authenticationToken: getJsonField(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (currentAuthenticationToken != null &&
                                                                              currentAuthenticationToken != '') {
                                                                            _model.cancelapiResulta5j =
                                                                                await KMartAPIsGroup.tokenValidetionCall.call(
                                                                              token: currentAuthenticationToken,
                                                                            );

                                                                            if (!(_model.cancelapiResulta5j?.succeeded ??
                                                                                true)) {
                                                                          ...
                                                                          if (confirmDialogResponse) {
                                                                            _model.apiResultmuj =
                                                                                await KMartAPIsGroup.orderCanceledCall.call(
                                                                              orderId: getJsonField(
                                                                                getordersItem,
                                                                                r'''$.order_id''',
                                                                              ).toString(),
                                                                            ...
                                                                            if ((_model.apiResultmuj?.succeeded ??
                                                                                true)) {
                                    ...
                                    return Builder(
                                      builder: (context) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          scrollDirection: Axis.vertical,
                                          itemCount: getcancelledorders.length,
                                          itemBuilder: (context,
