            ...
            child: Stack(
              children: [
                FutureBuilder<ApiCallResponse>(
                  future: KMartAPIsGroup.getAboutUsApiCall.call(),
                  builder: (context, snapshot) {
                    ...
                    final columnGetAboutUsApiResponse = snapshot.data!;
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      getJsonField(
                                        columnGetAboutUsApiResponse.jsonBody,
                                        r'''$.data.name''',
                                      ).toString(),
